...
import (
	...
	"github.com/hirokisan/goa/goagen/utils"
)
...
func (g *Generator) generateClient(clientFile string, clientPkg string, funcs template.FuncMap) (err error) {
	...
	for packagePath := range im {
		if packagePath != "github.com/hirokisan/goa" {
	...
	imports := []*codegen.ImportSpec{
		...
		codegen.SimpleImport("github.com/hirokisan/goa"),
		codegen.NewImport("goaclient", "github.com/hirokisan/goa/client"),
		codegen.NewImport("uuid", "github.com/hirokisan/goa/uuid"),
	}
