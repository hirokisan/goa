...
var _ = Describe("Validation", func() {
	...
	Describe("EncoderDefinition", func() {
		...
		BeforeEach(func() {
			enc = &EncodingDefinition{MIMETypes: []string{"application/foo"}, Encoder: true, PackagePath: "github.com/hirokisan/goa/encoding/foo"}
			...
			cellarPath = path.Join(oldWorkingDir, "tmp_gopath/src/github.com/hirokisan/goa_fake_cellar")
		...
		Context("with package in vendor", func() {
			BeforeEach(func() {
				packagePath := path.Join(cellarPath, "vendor/github.com/hirokisan/goa/encoding/foo")
